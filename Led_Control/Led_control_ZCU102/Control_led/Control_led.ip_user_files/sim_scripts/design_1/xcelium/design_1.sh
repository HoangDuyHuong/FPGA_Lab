...
execute()
{
  xrun $xrun_opts \
       ...
       -f run.f \
       -top glbl \
       +incdir+"$ref_dir/../../../../Control_led.gen/sources_1/bd/design_1/ipshared/ec67/hdl" \
       +incdir+"$ref_dir/../../../../Control_led.gen/sources_1/bd/design_1/ipshared/abef/hdl" \
       +incdir+"../../../../Control_led.gen/sources_1/bd/design_1/ipshared/ec67/hdl" \
       +incdir+"../../../../Control_led.gen/sources_1/bd/design_1/ipshared/abef/hdl" \
       +incdir+"D:/vivado_Xilinx_full/Vivado/2022.2/data/xilinx_vip/include" \
       -input simulate.do
}
